...
//! A progress bar widget with a flat appearance.
...
impl SimpleProgressBar {
    /// Return a new `SimpleProgressBar`.
    pub fn new() -> SimpleProgressBar {
        Self::default()
    }
}

impl Widget<f64> for SimpleProgressBar {
    ...
    fn layout(
        ...
        bc.debug_check("SimpleProgressBar");
